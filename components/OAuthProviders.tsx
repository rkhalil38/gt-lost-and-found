...
const OAuthProviders = () => {
    ...
    return (
        <div className='flex flex-col gap-2 w-1/6'>
            <button onClick={signInWithGoogle} className='flex flex-row duration-300 hover:bg-mainHover items-center justify-center gap-2 rounded-lg border-[1px] border-gray-600'>
                <svg className="my-2" width="30px" height="30px" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <button onClick={signInWithGithub} className='flex flex-row duration-300 hover:bg-mainHover items-center justify-center gap-2 rounded-lg border-[1px] border-gray-600'>
                <BsGithub className="hover:cursor-pointer h-[30px] w-[30px] my-2"/>
                <p className="text-white">Sign in with Github</p>
            </button>
            <button onClick={signInWithFacebook} className='flex flex-row duration-300 hover:bg-mainHover items-center justify-center gap-2 rounded-lg border-[1px] border-gray-600'>
            <svg className='my-2' width="30px" height="30px" viewBox="0 0 48 48" version="1.1" xmlns="http://www.w3.org/2000/svg">
