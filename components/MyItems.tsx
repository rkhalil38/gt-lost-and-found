...
const MyItems = () => {
    ...
    return (
        <div className={`flex flex-wrap items-center w-full h-full gap-4 p-10 mt-16`}>
            ...
            :
                (user?
                    ...
                    <div className='flex flex-col items-center justify-self-center self-center gap-4'>
                        ...
                        <Link 
                        className='flex w-24 bg-gtGold hover:bg-gtGoldHover text-sm duration-500 rounded-lg items-center justify-center p-2' href='/login'>
                            Login
                        </Link>
                    </div>
