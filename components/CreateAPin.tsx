                ...
                (user ?
                    ...
                    (
                        <div className='flex flex-col gap-4 w-full h-full items-center justify-center'>
                            ...
                            <Link href={'/login'} className='flex w-36 h-10 duration-300 text-xs rounded-lg border-[1px] items-center justify-center bg-gtGold text-white hover:bg-gtGoldHover'>
                                Sign In
                            </Link>
                        </div>
                    )
