  ...
  return (
    <div className="flex items-start justify-start py-28 px-10 w-screen min-h-screen">
      <div className={`flex flex-wrap gap-6 w-full`}>
        {loading ? (
          <div className="flex flex-col border-[1px] border-gray-600 cursor-pointer duration-500 gap-4 p-2 items-center w-72 h-96 bg-mainHover rounded-lg">
            ...
            pins.map((pin) => (
              <Link
                ...
                key={pin.created_at}
                className={`flex flex-col group hover:bg-mainHover2 border-[1px] border-gray-600 cursor-pointer duration-300 gap-4 p-2 items-center w-72 h-96 bg-mainHover shadow-lg rounded-lg`}
              >
