      ...
      <div className="flex w-3/6 flex-col gap-4 self-center py-32">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1">
            ...
            <p className="">
              We collect the information you provide, such as your name and
              contact information, when you sign up.
            </p>
          </div>
          <div className="flex flex-col gap-1">
            ...
            <p className="">
              ...
              includes what pages you visited, your operating system, and your
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1">
            ...
            <p className="">
              GT Lost and Found does not and will not sell your information to
              third parties.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1">
            ...
            <p className="">
              GT Lost and Found may update this policy at any time. Policy
